...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Apure'";
if (!empty($ciudad)) {
...
<head>
    ...
    <title>Apure</title><!--//----------revisar estado----------//-->
    ...
    <style>
        ...
        #Cumana { top: 50%; left: 60%; }
        #Palo_Negro { top: 70%; left: 40%; }
    </style>
</head>
<body>
    <header>
        <a href="Mapa.html" class="menu-button">&#8592; Mapa</a>
        <h1>Directorio de Locales - Apure</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Apure</h2><!--//----------revisar estado----------//-->
