...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Guárico'";
...
<head>
    ...
    <title>Guárico</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Guárico</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Guárico</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Guarico.png" alt="Mapa del estado Guárico"> 
