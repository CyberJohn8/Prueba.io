...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Carabobo'";
...
<head>
    ...
    <title>Carabobo</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Carabobo</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Carabobo</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Carabobo.png" alt="Mapa del estado Carabobo"> 
