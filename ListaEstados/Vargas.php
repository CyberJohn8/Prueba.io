...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Vargas'";
...
<head>
    ...
    <title>Vargas</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Vargas</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Vargas</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Vargas.png" alt="Mapa del estado Vargas"> 
