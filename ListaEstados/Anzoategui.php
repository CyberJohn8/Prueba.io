...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Anzoátegui'";
...
<head>
    ...
    <title>Anzoátegui</title><!--//----------revisar estado----------//-->
    ...
    <style>
        ...
        #El_Tigrito { top: 50%; left: 60%; }
        #Puerto_La_Cruz { top: 70%; left: 40%; }
    </style>
</head>
<body>
    <header>
        <a href="Mapa.html" class="menu-button">&#8592; Mapa</a>
        <h1>Directorio de Locales - Anzoátegui</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Anzoátegui</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Anzoategui.png" alt="Mapa del estado Anzoátegui"> 
            <button class="location-button" id="El_Tigrito" onclick="filterByCity('El Tigrito')">El Tigrito</button>
            <button class="location-button" id="Puerto_La_Cruz" onclick="filterByCity('Puerto La Cruz')">Puerto La Cruz</button>
