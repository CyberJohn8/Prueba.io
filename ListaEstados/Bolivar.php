...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Bolívar'";
...
<head>
    ...
    <title>Amazonas</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Bolívar</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Bolívar</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Bolivar.png" alt="Mapa del estado Bolívar"> 
