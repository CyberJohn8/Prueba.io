...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Aragua'";
...
<head>
    ...
    <title>Aragua</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Aragua</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Aragua</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Aragua.png" alt="Mapa del estado Aragua"> 
            <button class="location-button" id="San_Carlos" onclick="filterByCity('San Carlos')">San Carlos</button>
            <button class="location-button" id="San_" onclick="filterByCity('San')">San</button>
