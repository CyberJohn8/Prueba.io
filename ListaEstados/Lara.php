...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Lara'";
...
<head>
    ...
    <title>Lara</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Lara</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Lara</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Lara.png" alt="Mapa del estado Lara"> 
