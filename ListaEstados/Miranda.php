...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Miranda'";
...
<head>
    ...
    <title>Miranda</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Miranda</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Miranda</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Miranda.png" alt="Mapa del estado Miranda"> 
