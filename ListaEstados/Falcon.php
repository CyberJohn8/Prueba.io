...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Falcón'";
...
<head>
    ...
    <title>Falcón</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Falcón</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Falcón</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Falcon.png" alt="Mapa del estado Falcón"> 
