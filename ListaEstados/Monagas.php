...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Monagas'";
...
<head>
    ...
    <title>Monagas</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Monagas</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Monagas</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Monagas.png" alt="Mapa del estado Monagas"> 
