...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Cojedes'";
...
<head>
    ...
    <title>Cojedes</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Cojedes</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Cojedes</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Cojedes.png" alt="Mapa del estado Cojedes"> 
