...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Barinas'";
...
<head>
    ...
    <title>Barinas</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Barinas</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Barinas</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Barinas.png" alt="Mapa del estado Barinas"> 
