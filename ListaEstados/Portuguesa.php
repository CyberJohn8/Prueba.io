...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Portuguesa'";
...
<head>
    ...
    <title>Portuguesa</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Portuguesa</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Portuguesa</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Portuguesa.png" alt="Mapa del estado Portuguesa"> 
