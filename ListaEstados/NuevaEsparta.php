...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Nueva Esparta'";
...
<head>
    ...
    <title>Nueva Esparta</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Nueva Esparta</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Nueva Esparta</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/NuevaEsparta.png" alt="Mapa del estado Nueva Esparta"> 
