...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Trujillo'";
...
<head>
    ...
    <title>Trujillo</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Trujillo</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Trujillo</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Trujillo.png" alt="Mapa del estado Trujillo"> 
