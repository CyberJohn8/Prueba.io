...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Zulia'";
...
<head>
    ...
    <title>Zulia</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Zulia</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Zulia</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Zulia.png" alt="Mapa del estado Zulia"> 
