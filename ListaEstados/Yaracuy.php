...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Yaracuy'";
...
<head>
    ...
    <title>Yaracuy</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Yaracuy</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Yaracuy</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Yaracuy.png" alt="Mapa del estado Yaracuy"> 
