...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Sucre'";
...
<head>
    ...
    <title>Sucre</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Sucre</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Sucre</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Sucre.png" alt="Mapa del estado Sucre"> 
