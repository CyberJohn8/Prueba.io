...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Delta Amacuro'";
...
<head>
    ...
    <title>Delta Amacuro</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Delta Amacuro</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Delta Amacuro</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Delta_Amacuro.svg" alt="Mapa del estado Delta Amacuro"> 
