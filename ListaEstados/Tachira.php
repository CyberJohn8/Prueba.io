...
$query = "SELECT ID, Nombre, Estado, Ciudad FROM asambleas_de_venezuela WHERE Estado = 'Táchira'";
...
<head>
    ...
    <title>Táchira</title><!--//----------revisar estado----------//-->
...
<body>
    <header>
        ...
        <h1>Directorio de Locales - Táchira</h1><!--//----------revisar estado----------//-->
    </header>

    <main class="content">
        <section class="map-section">
            <h2>Estado Táchira</h2>   <!--//----------revisar estado----------//-->
            <img src="../assets/Tachira.png" alt="Mapa del estado Táchira"> 
